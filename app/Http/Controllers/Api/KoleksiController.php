...
//         'content_type' => 'required|in:pdf,youtube', // Validasi tipe konten
//     ]);
...
//     // Lakukan preprocessing hanya untuk judul dan ringkasan
//     $this->performPreprocessing($koleksi);
    ...
    public function update(Request $request, Koleksi $koleksi)
{
    ...
    // Validasi tambahan: pastikan hanya satu jenis konten yang diisi
    if ($request->content_type === 'pdf' && !$request->hasFile('dokumen_pdf') && !$koleksi->dokumen_pdf && !($request->has('remove_file') && $request->remove_file === 'true')) {
        // Jika content_type PDF tapi tidak ada file baru dan tidak ada file lama dan tidak menghapus file
    ...
    // If content type is YouTube, remove PDF file
...
/**
 * Menampilkan PDF untuk admin tanpa menambahkan ke riwayat baca
 */
/**
 * Menampilkan PDF untuk admin tanpa menambahkan ke riwayat baca
 */
